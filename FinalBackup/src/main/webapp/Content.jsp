...
<body>
	...
	<!-- 게시물 출력, 수정,삭제, 댓글기능  -->
		...
		<%if(view.get(0).getNick().equals(nick)){%>
			...
			<a onclick = "return confirm('정말로 삭제하시겠습니까?')" href = "WriterDeleteCon?bo_num=<%=view.get(0).getBo_num()%>">삭제</a>
		...
		<a onclick = "return confirm('정말로 삭제?')">사악ㅈ</a>
	...
	<form action="ReplyCon"   method="post">
		<table border="1">
			<tr>
